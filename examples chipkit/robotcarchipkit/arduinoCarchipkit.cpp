...
rbaMotorDriver motorDriver(A1, 10, 9, A0, 6, 5);

//Bluetooth Pins ( INT)
rbaBluetooth bluetooth;

//Ultrasonic Pins(Trig,Echo)
rbaUltrasonicSensor ultrasonicSensor(A4, A5);

//LineFinder Pins(Sensor1, Sensor2)
rbaLineFinder lineFinder(A2, A3);

//Define string variables for mode and joystic head
String modeHead(_MODE_HEAD);
String joystickHead(_JOYSTICK_HEAD);
